...
//				$this->SetValue("mowerVoltageBattery", $data['health']['voltages']['batt']/1000);
    	...
    	#================================================================================================
			...
			$this->RegisterVariableString( "LastServiceTechnician", "Letzte Expertwartung", "", 0);
			...
			$this->RegisterVariableInteger("RegenerativRemaining_days", "RegenerativRemaining_days", "", 21 );
